var colecao_series_programacao = [
    ...
    { nome: "Dois Homens e Meio",     horario: "5h",     sinopse: "Uma sitcom que acompanha as desventuras de um solteirão rico e seu irmão neurótico e sobrinho pré-adolescente, que se mudam para sua casa de praia em Malibu "}
];

var data_atual = new Date(); // guardando o valor da data atual em uma variável
var dia_semana = data_atual.getDay(); // getDay() retorna o dia da semana com calores de 0 a6.
                                      //Usamos o valor retornado para acessar um objeto da coleção.

var serie_do_dia = colecao_series_programacao[dia_semana];

var nome_serie = serie_do_dia.nome;
var horário_serie = serie_do_dia.horario; // Guardando os dados do objeto serie_do_dia em variáveis
var sinopse_serie = serie_do_dia.sinopse;

console.log("Hoje é dia de "+ nome_serie+ " às "+ horário_serie);
