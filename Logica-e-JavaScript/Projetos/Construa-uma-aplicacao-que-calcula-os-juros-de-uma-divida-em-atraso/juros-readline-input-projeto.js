...
if(valor_divida > 0){
    let dias_vencimento = entradaDados.question("Informe quantos dias se passaram desde o vencimento do boletos: ");
    ...
    if(dias_vencimento > 0)
    {
        if(dias_vencimento > 15)
            ...
            console.log("\nValor original da dívidas: R$ "+valor_divida);
    ...
    console.log("O valor da dívida dese ser maior que zero!");
}
