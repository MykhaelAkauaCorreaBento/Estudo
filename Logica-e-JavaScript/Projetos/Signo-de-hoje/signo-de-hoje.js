...
const retorna_signo = (signos, data) =>{
   ...
   //Estrutura para percorrer os signos
   for(const signo of signos){
        let data_inicio_signo = new Date(ano + "-" + signo["DataInicio"] + " 00:00:00");
        let data_fim_signo = new Date(ano + "-" + signo["DataFim"] + " 23:59:59");

        //Verifica se a data informada está no range da data inicial e data final do signo. Caso esteja, o nome do signo é retornado.
        
        let tipo_comparacao = signo["DataInicio"] == "12-22" ? "or" : "and";
        

        //Se tipo_comparacao for igual a "and" verificamos se a data setá 'completamente dentro' do range.
        ...
        //Se tipo_comparacao for igual a "or" verificamos se a data está 'parcialmente dentro' do range.    
...
let data_app = new Date("2025-12-30 00:00:00");
