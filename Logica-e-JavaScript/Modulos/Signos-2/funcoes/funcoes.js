...
//A função de apoi verifica_data_range não foi exportada pois só é usada
//localmente, pela função retorna_signo.

//Obs.:Se uma função só é usada localmente (no mesmo arquivo) não há a necessidade de ela ser exportada.