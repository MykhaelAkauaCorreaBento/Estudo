...
//Função de verificar o alcance(coleção)
...
//Obs.: A função verificar_data_range recebe 4 parâmetros: 3 deles são as datas
//a serem comparadas e 1 representa a forma como será essa comparação.


//Função de verificar data e imprimir o signo.
